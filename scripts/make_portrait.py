...
Run it once; it is not on a schedule, unlike scripts/generate_stats.py.
    ...
    uv run scripts/make_portrait.py photo.png --crop 400,110,910,790
    uv run scripts/embed_portrait_font.py      # inline the font, see below
...
def main():
    ...
    print("next: uv run scripts/embed_portrait_font.py")
